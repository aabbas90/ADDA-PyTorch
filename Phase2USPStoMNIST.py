...
sourceTrainDataset = USPSSAMPLE(root='./data/', num_training_samples=7438, train=True, transform=transforms.ToTensor())

sourceTestDataset = USPSSAMPLE(root='./data/', num_training_samples=1860, train=False, transform=transforms.ToTensor())
